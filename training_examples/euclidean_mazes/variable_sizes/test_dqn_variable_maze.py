...
final_epsilon=0.05
epsilon_decay= maze_max_shape[0]*maze_max_shape[1] // 2
discount_factor=0.5
eta = 1e-2
batch_size=128
...
agent = DQNAgent(env,learning_rate=learning_rate,starting_epsilon=starting_epsilon,final_epsilon=final_epsilon,epsilon_decay=epsilon_decay,discount_factor=discount_factor,eta=eta,batch_size=batch_size,memory_size=20000,target_update_frequency=1,device=device)
