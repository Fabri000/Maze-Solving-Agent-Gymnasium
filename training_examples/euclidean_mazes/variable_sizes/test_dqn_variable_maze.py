...
n_episodes = 200
learning_rate=1e-3
starting_epsilon=0.97
final_epsilon=0.15
epsilon_decay= ((maze_max_shape[0]-1)*(maze_max_shape[1]-1) // 2) * 5
discount_factor=0.7
eta = 1e-2
batch_size=128
...
agent = DQNAgent(env,learning_rate=learning_rate,starting_epsilon=starting_epsilon,final_epsilon=final_epsilon,epsilon_decay=epsilon_decay,discount_factor=discount_factor,eta=eta,batch_size=batch_size,memory_size=50000,target_update_frequency=1,device=device)
