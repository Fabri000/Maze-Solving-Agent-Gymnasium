...
from gymnasium_env.envs.toroidal_maze_env import ToroidalEnrichMazeEnv
...
env = ToroidalEnrichMazeEnv(maze_shape)
env = gym.wrappers.RecordEpisodeStatistics(env, buffer_length=n_episodes)

agent = DQNAgent(env,learning_rate=learning_rate,starting_epsilon=starting_epsilon,final_epsilon=final_epsilon,epsilon_decay=epsilon_decay,discount_factor=discount_factor,eta=eta,batch_size=batch_size,memory_size=100000,target_update_frequency=2,device=device)

log_dir = "logs/tor_dqn_logs"
