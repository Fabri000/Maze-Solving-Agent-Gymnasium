...
def get_mask_tensor(maze,position):
    ...
    decision_mask = (maze_tensor == 1).int() # decision mask is generated by the function get_decision_mask
    ...
    final_tensor = torch.stack([wall_mask,decision_mask,player_mask,goal_mask])
